...
const navigation: NavigationItem[] = [
  ...
  { name: "Gestion Hedera", path: "/hedera", icon: Share2 },
...
export default function Sidebar() {
  ...
  return (
    <div className="bg-white w-80 shadow-2xl border-r border-gray-200 flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center h-40 px-6 border-b border-gray-200 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <img
            src={logoAagri}
            alt="Agrilent Logo"
            className="w-auto max-w-[200px] h-auto object-contain shadow-lg bg-white"
            onError={(e) => {
      ...
      {/* Navigation */}
      <nav className="flex-1 px-4 py-5 mt-4 overflow-y-auto">
