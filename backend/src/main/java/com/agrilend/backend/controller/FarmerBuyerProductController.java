...
@Tag(name = "Common Products", description = "API pour la gestion des produits accessible aux agriculteurs et acheteurs")
@SecurityRequirement(name = "bearerAuth")
@PreAuthorize("hasAnyRole('FARMER', 'BUYER')")
@CrossOrigin(origins = "*", maxAge = 3600)
public class FarmerBuyerProductController {
